...
// color ends
  ...
  return (
    ...
    <FlexBetween padding="1rem" gap="10rem" backgroundColor={alt} position="fixed" zIndex="10" width="100%">
      ...
      {isNonMobileScreens ? (
        <FlexBetween gap="2rem">
          {/* button for light and dark mode  */}
            <Button onClick={() => navigate('/recmd')}>
              Crop Recommend
            </Button>
            <Button onClick={() => navigate('/advtech')}>
              Latest Technology
            </Button>
          ...
          {/* // message icon  */}
          <IconButton><Message sx={{ fontSize: "25px" }} onClick={() => navigate("/chat")}/></IconButton>
          {/* // Notifications icon */}
